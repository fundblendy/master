...
function gacha(){
    ...
    var gacha_1 = ["./static/img/Card/Axe.ico", "バトルアクス","ランダム単体にダメージ","固定ダメージ [10]","",""]
    var gacha_2 = ["./static/img/Card/Axe.ico", "バトルアクス","ランダム単体にダメージ","固定ダメージ [10]","",""]
    var gacha_3 = ["./static/img/Card/Axe.ico", "バトルアクス","ランダム単体にダメージ","固定ダメージ [10]","",""]
    var gacha_4 = ["./static/img/Card/Axe.ico", "バトルアクス","ランダム単体にダメージ","固定ダメージ [10]","",""]
    var gacha_5 = ["./static/img/Card/Axe.ico", "バトルアクス","ランダム単体にダメージ","固定ダメージ [10]","",""]
    ...
    for (var i = 0 ; i <=4 ; i++ ){
        ...
        if (a >= 1 && a <= 10){
            gacha[i][0] = "./static/img/Card/Axe.ico";
            gacha[i][1] = "バトルアクス";
        ...
        if (a >= 11 && a <= 20){
            gacha[i][0] = "./static/img/Card/sword.ico";
            gacha[i][1] = "アイアンソード";
        ...
        if (a >= 41 && a <= 50){
            gacha[i][0] = "./static/img/Card/ele_thunder.ico";
            gacha[i][1] = "ライトニングボルト";
            gacha[i][2] = "敵全体にダメージ";
        ...
        if (a >= 51 && a <= 60){
            gacha[i][0] = "./static/img/Card/Potion.ico";
            gacha[i][1] = "ノーマルポーション";
            gacha[i][2] = "使用者を回復";
            gacha[i][3] = "固定回復 ["+(10+c)+"]"
        ...
        if (a >= 61 && a <= 70){
            gacha[i][0] = "./static/img/Card/Art of Chemistry.ico";
            gacha[i][1] = "レアポーション";
            gacha[i][2] = "味方全体を回復";
            gacha[i][3] = "固定回復 ["+b+"]"
            gacha[i][4] = "追加回復 [1~"+(2+c)+"]"
        ...
        if (a >= 71 && a <= 80){
            gacha[i][0] = "./static/img/Card/ele_fire.ico";
            gacha[i][1] = "ファイアボルト";
            gacha[i][2] = "敵単体[2]にダメージ";
        ...
        if (a >= 81 && a <= 90){
            gacha[i][0] = "./static/img/Card/potion_2.ico";
        ...
        if (a >= 91 && a <= 92){
            gacha[i][0] = "./static/img/Card/ele_wind.ico";
            gacha[i][1] = "テラウィンド";
            gacha[i][2] = "敵全体にダメージ";
        ...
        if (a >= 93 && a <= 94){
            gacha[i][0] = "./static/img/Card/ele_water.ico";
            gacha[i][1] = "アクアスパイク";
            gacha[i][2] = "敵単体[1]にダメージ";
            gacha[i][3] = "固定ダメージ ["+(10+c)+"]"
        ...
        if (a >= 95 && a <= 96){
            gacha[i][0] = "./static/img/Card/ele_ice.ico";
            gacha[i][1] = "アイスフォール";
            gacha[i][2] = "敵単体[3]にダメージ";
            gacha[i][3] = "固定ダメージ ["+(10+c)+"]"
            gacha[i][4] = "追加ダメージ [1~"+(7+c)+"]"
        ...
        if (a >= 97 && a <= 98){
            gacha[i][0] = "./static/img/Card/ele_earth.ico";
            gacha[i][1] = "タイタンクエイク";
            gacha[i][2] = "敵全体にダメージ";
            gacha[i][3] = "固定ダメージ [1]"
